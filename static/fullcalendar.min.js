(function (t) {
  ...
  function o(e) {
    function i(i, n) {
      t.isPlainObject(n) && t.isPlainObject(e[i]) && !s(i)
        ? (e[i] = o({}, e[i], n))
        : void 0 !== n && (e[i] = n);
    }
  ...
  function l(i, n) {
    ...
    function l() {
      (ne = K.theme ? "ui" : "fc"),
        ...
        K.handleWindowResize &&
          ((se = L(v, K.windowResizeDelay)), t(window).resize(se));
    }
    function d() {
      re && re.destroy(),
        te.destroy(),
    ...
    function f(e, i) {
      he++,
        ...
        !re &&
          ...
          te.activateButton(i)),
        re &&
          (e && (le = re.incrementDate(le, e)),
          (re.start && !e && le.isWithin(re.intervalStart, re.intervalEnd)) ||
            (h() &&
              (I(),
              re.start && re.destroy(),
              re.render(le),
    ...
    function m() {
      oe =
        "number" == typeof K.contentHeight
          ? K.contentHeight
          : "number" == typeof K.height
          ? K.height - (ee ? ee.outerHeight(!0) : 0)
          : Math.round(ie.width() / Math.max(K.aspectRatio, 0.5));
    }
    function v(t) {
      !he &&
        t.target === window &&
    ...
    function x() {
      var t = q.getNow();
      t.isWithin(re.intervalStart, re.intervalEnd)
        ? te.disableButton("today")
        : te.enableButton("today");
    }
    function k(t, e) {
      (t = q.moment(t)),
        (e = e
          ? q.moment(e)
          : t.hasTime()
          ? t.clone().add(q.defaultTimedEventDuration)
          : t.clone().add(q.defaultAllDayEventDuration)),
        re.select(t, e);
    }
    function M() {
      re && re.unselect();
    ...
    function $(t, e) {
      return K[t]
        ? K[t].apply(e || de, Array.prototype.slice.call(arguments, 2))
        : void 0;
    }
    var q = this;
    n = n || {};
    ...
    var Q = H(r(K.lang));
    if (
      (K.monthNames && (Q._months = K.monthNames),
    ...
    (q.defaultAllDayEventDuration = e.duration(K.defaultAllDayEventDuration)),
      ...
      (q.moment = function () {
        ...
        return (
          "local" === K.timezone
            ? ((t = He.moment.apply(null, arguments)), t.hasTime() && t.local())
            : (t =
                "UTC" === K.timezone
      ...
      (q.getDefaultEventEnd = function (t, e) {
        ...
        return (
          t
            ? i.stripTime().add(q.defaultAllDayEventDuration)
            : i.add(q.defaultTimedEventDuration),
      ...
      (q.formatRange = function (t, e, i) {
        return (
          "function" == typeof i && (i = i.call(q, K, Q)),
                ...
                : (e[r]
                  ...
                  l &&
                    ...
                    (u = h
                      ? R(h)
                      : a && i.theme
                      ? "<span class='ui-icon ui-icon-" + a + "'></span>"
                      : c && !i.theme
                      ? "<span class='fc-icon fc-icon-" + c + "'></span>"
                      : R(d || r)),
                    (g = [
                      "fc-" + r + "-button",
                      f + "-button",
                    ...
                    (m = t(
                      ...
                      .click(function () {
                        m.hasClass(f + "-state-disabled") ||
                          (l(),
                          (m.hasClass(f + "-state-active") ||
                            m.hasClass(f + "-state-disabled")) &&
                            m.removeClass(f + "-state-hover"));
                      })
                      .mousedown(function () {
                        m.not("." + f + "-state-active")
                      ...
                      .hover(
                        ...
                        function () {
                          m.removeClass(f + "-state-hover").removeClass(
                            f + "-state-down"
                          );
                        }
                      )),
  ...
  function c(e) {
    function i(t, e) {
      return (
        !T ||
        t.clone().stripZone() < T.clone().stripZone() ||
        e.clone().stripZone() > C.clone().stripZone()
      );
    }
    function n(t, e) {
      (T = t), (C = e), (A = []);
    ...
    function r(e, i) {
      o(e, function (n) {
        var r,
          o,
          s = t.isArray(e.events);
        if (i == G) {
          if (n)
            for (r = 0; n.length > r; r++)
              (o = n[r]), s || (o = w(o, e)), o && A.push(o);
          N--, N || R(A);
        }
      });
    }
    function o(i, n) {
      ...
      for (r = 0; l.length > r; r++) {
        if (
          ((s = l[r].call(S, i, T.clone(), C.clone(), e.timezone, n)), s === !0)
        )
          return;
        ...
        for (
          i.className
            ? "string" == typeof i.className &&
              (i.className = i.className.split(/\s+/))
            : (i.className = []),
            t.isArray(i.events) &&
    ...
    function h(t) {
      return (
        ("object" == typeof t ? t.origArray || t.url || t.events : null) || t
      );
    }
    function u(t) {
      ...
      for (e = 0; A.length > e; e++)
        if (((i = A[e]), i._id == t._id && i !== t))
          for (n = 0; V.length > n; n++)
            (r = V[n]), void 0 !== t[r] && (i[r] = t[r]);
    }
    function g(t, e) {
      var i = w(t);
      i &&
        (i.source || (e && (z.events.push(i), (i.source = z)), A.push(i)),
        R(A));
    }
    function p(e) {
      var i, n;
    ...
    function w(i, n) {
      var r,
        ...
        a = {};
      return (
        e.eventDataTransform && (i = e.eventDataTransform(i)),
        n && n.eventDataTransform && (i = n.eventDataTransform(i)),
        (r = S.moment(i.start || i.date)),
        r.isValid() &&
        ((o = null), !i.end || ((o = S.moment(i.end)), o.isValid()))
          ? ((s = i.allDay),
            void 0 === s &&
              ((l = M(n ? n.allDayDefault : void 0, e.allDayDefault)),
              (s = void 0 !== l ? l : !(r.hasTime() || (o && o.hasTime())))),
            s
              ? (r.hasTime() && r.stripTime(),
                o && o.hasTime() && o.stripTime())
              : (r.hasTime() || (r = S.rezoneDate(r)),
    ...
    function E(t, e, i) {
      var n,
        ...
        d = !1;
      return (
        e || i || ((e = t.start), (i = t.end)),
        (n = t.allDay != l ? t.allDay : !(e || i).hasTime()),
        n &&
          (e && (e = e.clone().stripTime()), i && (i = i.clone().stripTime())),
        e && (r = n ? D(e, a.clone().stripTime()) : D(e, a)),
        n != l
          ? (d = !0)
          : i &&
            (o = D(i || S.getDefaultEventEnd(n, e || a), e || a).subtract(
              D(c || S.getDefaultEventEnd(l, a), a)
            )),
        (s = b(m(t._id), d, n, r, o)),
        {
          dateDelta: r,
      ...
      return (
        t.each(i, function (t, i) {
          var c = i._allDay,
            ...
            p = !n && u ? u.clone() : null;
          f
            ? (g.stripTime(), p && p.stripTime())
            : (g.hasTime() || (g = S.rezoneDate(g)),
              p && !p.hasTime() && (p = S.rezoneDate(p))),
            p ||
              (!e.forceEventDuration && !+s) ||
              (p = S.getDefaultEventEnd(f, g)),
            g.add(o),
            p && p.add(o).add(s),
            l && (+o || +s) && (g.stripZone(), p && p.stripZone()),
            (i.allDay = f),
            (i.start = g),
            (i.end = p),
            d(i),
    ...
    var T,
      ...
      A = [];
    t.each(
      (e.events ? [e.events] : []).concat(e.eventSources || []),
      function (t, e) {
        var i = l(e);
        i && L.push(i);
      }
  ...
  function m(t, e) {
    return (
      ...
      t[0].scrollHeight - 1 > t[0].clientHeight ? !0 : (v(t), !1)
    );
  }
  function v(t) {
  ...
  function b(t, e, i, n) {
    var r, o, s, l;
    return e > i && n > t
      ? (t >= i ? ((r = t.clone()), (s = !0)) : ((r = i.clone()), (s = !1)),
        n >= e ? ((o = e.clone()), (l = !0)) : ((o = n.clone()), (l = !1)),
        {
          start: r,
          end: o,
          isStart: s,
  ...
  function O(t, e) {
    ...
    return "string" == typeof e
      ...
      ? Le[i]
        ? Le[i](t)
        : A(t, i)
      : e.maybe && ((n = _(t, e.maybe)), n.match(/[1-9]/))
      ? n
      : "";
  }
  ...
  function F(t, e, i, n, r) {
    ...
    for (l = i.length - 1; l > s && ((o = I(t, e, i[l])), o !== !1); l--)
      d = o + d;
  ...
  function I(t, e, i) {
    ...
    return "string" == typeof i
      ? i
      : (n = i.token) && ((r = Ge[n.charAt(0)]), r && t.isSame(e, r))
      ? A(t, n)
      : !1;
  }
  function Z(t) {
  ...
  function U(t, e) {
    return t || e
      ? t && e
        ? t.grid === e.grid && t.row === e.row && t.col === e.col
        : !1
      : !0;
  }
  function K(e, i) {
  ...
  function ie(t, e) {
    ...
    for (i = 0; e.length > i; i++)
      if (((n = e[i]), n.leftCol <= t.rightCol && n.rightCol >= t.leftCol))
        return !0;
    return !1;
  }
  function ne(t, e) {
  ...
  function le(t) {
    ...
    for (e = 0; t.length > e; e++)
      for (i = t[e], n = 0; i.length > n; n++)
        for (r = i[n], r.forwardSegs = [], o = e + 1; t.length > o; o++)
  ...
  function ae(t) {
    ...
    if (void 0 === t.forwardPressure) {
      for (e = 0; n.length > e; e++)
        (i = n[e]), ae(i), (r = Math.max(r, 1 + i.forwardPressure));
      t.forwardPressure = r;
    }
  }
  function ce(t, e, i) {
  ...
  function fe(i) {
    ...
    function r(t, e) {
      return i.trigger.apply(
        i,
        [t, e || C].concat(Array.prototype.slice.call(arguments, 2), [C])
      );
    }
    function o(t) {
      var e = t.source || {};
    ...
    (function () {
      ...
      for (var e = 0, i = 0; 7 > e; e++)
        (L[e] = i), (z[e] = -1 != t.inArray(e, P)), z[e] || ((G[i] = e), i++);
    ...
    return (
      this.each(function (r, o) {
        ...
        "string" == typeof e
          ...
          : c || ((c = new l(a, e)), a.data("fullCalendar", c), c.render());
      }),
      n
    );
  }),
    ...
    (He.datepickerLang = function (e, i, n) {
      ...
      r || (r = Te[e] = {}),
        o(r, {
          ...
          titleFormat: {
            month: n.showMonthAfterYear
              ? "YYYY[" + n.yearSuffix + "] MMMM"
              : "MMMM YYYY[" + n.yearSuffix + "]"
          },
          defaultButtonText: {
            prev: P(n.prevText),
            next: P(n.nextText),
        ...
        t.datepicker &&
          ((t.datepicker.regional[i] = t.datepicker.regional[e] = n),
  ...
  (He.moment = function () {
    ...
    (N.prototype.time = function (t) {
      ...
      var i = 0;
      return (
        e.isDuration(t) && (i = 24 * Math.floor(t.asDays())),
        this.hours(i + t.hours())
          .minutes(t.minutes())
          .seconds(t.seconds())
    ...
    (N.prototype.zone = function (t) {
      return (
        null != t && (delete this._ambigTime, delete this._ambigZone),
    ...
    (N.prototype.toISOString = function () {
      return this._ambigTime
        ...
        : this._ambigZone
        ? A(this, "YYYY-MM-DD[T]HH:mm:ss")
        : e.fn.toISOString.apply(this, arguments);
    }),
    ...
    (N.prototype.isSame = function (t, i) {
      var n;
      return i
        ? ((n = Y([this, t], !0)), e.fn.isSame.call(n[0], n[1], i))
        : ((t = He.moment.parseZone(t)),
          e.fn.isSame.call(this, t) &&
  ...
  (j.prototype = {
    ...
    position: function () {
      ...
      (r = s.top || 0),
        ...
        h.is(window) || h.is(document)
          ? ((h = d), (e = 0), (i = 0))
          : ((n = h.offset()), (e = n.top), (i = n.left)),
        (e += d.scrollTop()),
        (i += d.scrollLeft()),
        s.viewportConstrain !== !1 &&
          ((r = Math.min(r, e + h.outerHeight() - c - this.margin)),
    ...
    (X.prototype = {
      ...
      inBounds: function (t, e) {
        return this.containerEl
          ? t >= this.minX && this.maxX > t && e >= this.minY && this.maxY > e
          : !0;
      }
    }),
    ($.prototype = {
    ...
    (q.prototype = {
      ...
      dragScroll: function (t) {
        ...
        s &&
          ...
          e >= 0 && 1 >= e
            ? (l = -1 * e * this.scrollSpeed)
            : i >= 0 && 1 >= i && (l = i * this.scrollSpeed),
          n >= 0 && 1 >= n
            ? (a = -1 * n * this.scrollSpeed)
            : r >= 0 && 1 >= r && (a = r * this.scrollSpeed)),
      ...
      constrainScrollVel: function () {
        var t = this.scrollEl;
        0 > this.scrollTopVel
          ? 0 >= t.scrollTop() && (this.scrollTopVel = 0)
          : this.scrollTopVel > 0 &&
            t.scrollTop() + t[0].clientHeight >= t[0].scrollHeight &&
            (this.scrollTopVel = 0),
          0 > this.scrollLeftVel
            ? 0 >= t.scrollLeft() && (this.scrollLeftVel = 0)
    ...
    (Q.prototype = {
      ...
      rowHtml: function (t, e) {
        var i,
          ...
          s = "";
        for (e = e || 0, i = 0; r.colCnt > i; i++)
          (n = r.cellToDate(e, i)), (s += o(e, i, n));
    ...
    t.extend(J.prototype, {
      ...
      bindHandlers: function () {
        ...
        this.el.on("mousedown", function (i) {
          t(i.target).is(".fc-event-container *, .fc-more") ||
            t(i.target).closest(".fc-popover").length ||
            e.dayMousedown(i);
        }),
        ...
        var e,
          ...
          a = new q(this.coordMap, {
            ...
            listenStop: function (t) {
              l &&
                (l[0].isSame(l[1]) && o.trigger("dayClick", n[0], e, t),
      ...
      renderRangeHelper: function (t, e, i) {
        ...
        !e &&
          ...
          (e = r.calendar.getDefaultEventEnd(!t.hasTime(), t)),
          (n = i ? H(i.event) : {}),
          (n.start = t),
          (n.end = e),
      ...
      bgCellHtml: function (t, e, i) {
        ...
        return (
          r.unshift("fc-day", n.widgetContentClass),
      ...
      getDayClasses: function (t) {
        ...
        return (
          "month" === e.name &&
            ...
            n.push("fc-other-month"),
          t.isSame(i, "day")
            ? n.push("fc-today", e.highlightStateClass)
            : i > t
            ? n.push("fc-past")
            : n.push("fc-future"),
          n
    ...
    t.extend(J.prototype, {
      ...
      eventToSegs: function (t, e, i) {
        var n,
          r,
          o,
          s = t.start.clone().stripZone(),
          l = this.view.calendar.getEventEnd(t).stripZone();
        for (
          e && i
            ? ((o = b(s, l, e, i)), (n = o ? [o] : []))
            : (n = this.rangeToSegs(s, l)),
            r = 0;
          n.length > r;
          r++
        )
        ...
        t.each(
          {
            ...
            mousedown: function (n, r) {
              t(r.target).is(".fc-resizer") && i.isEventResizable(n.event)
                ? e.segResizeMousedown(n, r)
                : i.isEventDraggable(n.event) && e.segDragMousedown(n, r);
            }
          },
          function (i, n) {
            e.el.on(i, ".fc-event-container > *", function (i) {
              var r = t(this).data("fc-seg");
              return !r || e.isDraggingSeg || e.isResizingSeg
                ? void 0
                : n.call(this, r, i);
            });
          }
      ...
      computeDraggedEventDates: function (t, e, i) {
        ...
        return (
          i.hasTime() === e.hasTime()
            ? ((n = D(i, e)),
              (r = a.clone().add(n)),
              (o = null === l.end ? null : c.clone().add(n)))
            : ((r = i), (o = null)),
          {
            start: r,
            end: o
        ...
        (n = new q(this.coordMap, {
          ...
          cellOver: function (e, n) {
            n.isBefore(a) && (n = a),
              ...
              d.isSame(c)
                ? ((d = null), i())
                : (r.renderResize(a, d, t), o.hideEvent(l));
          },
          cellOut: function () {
            (d = null), i();
          },
      ...
      getSegClasses: function (t, e, i) {
        var n = t.event,
          ...
          ].concat(n.important, n.source ? n.source.className : []);
    ...
    t.extend(ee.prototype, {
      ...
      renderDrag: function (t, e, i) {
        ...
        return (
          this.renderHighlight(
            t,
            e || this.view.calendar.getDefaultEventEnd(!0, t)
          ),
          i && !i.el.closest(this.el).length
      ...
      renderHelper: function (e, i) {
        ...
        this.rowEls.each(function (e, o) {
          ...
          (s =
            i && i.row === e
              ? i.el.position().top
              : l.find(".fc-content-skeleton tbody").position().top),
      ...
      destroyHighlight: function () {
        this.highlightEls &&
          (this.highlightEls.remove(), (this.highlightEls = null));
      },
      highlightSkeletonHtml: function (t, e) {
        ...
        return (
          t > 0 && (n += '<td colspan="' + t + '"/>'),
          e > t &&
            (n += '<td colspan="' + (e - t) + '" class="fc-highlight" />'),
          i > e && (n += '<td colspan="' + (i - e) + '"/>'),
          (n = this.bookendCells(n, "highlight")),
          '<div class="fc-highlight-skeleton"><table><tr>' +
            n +
            "</tr>" +
            "</table>" +
            "</div>"
    ...
    t.extend(ee.prototype, {
      ...
      destroyEvents: function () {
        var t, e;
        for (
          J.prototype.destroyEvents.call(this), t = this.rowStructs || [];
          (e = t.pop());
      ...
      renderEventRows: function (t) {
        var e,
          i,
          n = this.eventsToSegs(t),
          r = [];
        for (
          n = this.renderSegs(n), e = this.groupSegRows(n), i = 0;
          e.length > i;
          i++
        )
      ...
      renderSegHtml: function (t, e) {
        ...
        return (
          ...
          !o.allDay &&
            t.isStart &&
            (d =
              '<span class="fc-time">' + R(n.getEventTimeText(o)) + "</span>"),
          (i =
            '<span class="fc-title">' +
            (R(o.title || "") || "&nbsp;") +
            "</span>"),
              ...
              for (
                c = o[a],
                  ...
                  c.leftCol != c.rightCol
                    ? d.attr("colspan", c.rightCol - c.leftCol + 1)
                    : (y[r][s] = d);
                c.rightCol >= s;
    ...
    t.extend(ee.prototype, {
      ...
      computeRowLevelLimit: function (t) {
        ...
        for (e = 0; o.length > e; e++)
          if (
            ((i = o.eq(e).removeClass("fc-limited")),
      ...
      limitRow: function (e, i) {
        ...
        if (i && S.segLevels.length > i) {
          for (
            ...
            for (c = o[a], n(c.leftCol), u = [], h = 0; c.rightCol >= T; )
              (r = {
                row: e,
                col: T
              }),
        ...
        return t('<a class="fc-more"/>')
          ...
          .on("click", function (o) {
            ...
            "function" == typeof s &&
              ...
              "popover" === s
                ? n.showSegPopover(l, e, a, h)
                : "string" == typeof s && r.calendar.zoomTo(l, s);
          });
      },
      showSegPopover: function (t, e, i, n) {
        ...
        (r = 1 == l.rowCnt ? this.view.el : this.rowEls.eq(e.row)),
          ...
          l.opt("isRTL")
            ? (o.right = a.offset().left + a.outerWidth() + 1)
            : (o.left = a.offset().left - 1),
      ...
      renderSegPopoverContent: function (e, i) {
        ...
        for (
          i = this.renderSegs(i, !0), this.popoverSegs = i, n = 0;
          i.length > n;
          n++
        )
          (i[n].cellDate = e), a.append(i[n].el);
        return l;
      },
      ...
      getCellSegs: function (t, e) {
        for (
          var i, n = this.rowStructs[t.row].segMatrix, r = e || 0, o = [];
          n.length > r;

        )
          (i = n[r][t.col]), i && o.push(i), r++;
        return o;
      }
    }),
    ...
    t.extend(re.prototype, {
      ...
      slatRowHtml: function () {
        for (
          var t,
            ...
            s = r.opt("isRTL"),
            l = "",
            a = 0 === this.slotDuration.asMinutes() % 15,
            c = e.duration(+this.minTime);
          this.maxTime > c;
          ...
          (t = r.start.clone().time(c)),
            ...
            (n =
              ...
              (a && i
                ? ""
                : "<span>" +
                  R(o.formatDate(t, r.opt("axisFormat"))) +
                  "</span>") +
              "</td>"),
            (l +=
              "<tr " +
      ...
      rangeToSegs: function (t, e) {
        var i,
          ...
          a = [];
        for (
          t = t.clone().stripZone(), e = e.clone().stripZone(), n = 0;
          l.colCnt > n;
          n++
        )
          (r = l.cellToDate(0, n)),
      ...
      buildCoords: function (i, n) {
        var r,
          ...
          c = null;
        for (
          this.dayEls.slice(0, s).each(function (e, i) {
            (r = t(i)),
              (o = r.offset().left),
              c && (c[1] = o),
              (c = [o]),
      ...
      getCellDate: function (t) {
        var e = this.view,
          i = e.calendar;
        return i.rezoneDate(
          e.cellToDate(0, t.col).time(this.minTime + this.snapDuration * t.row)
        );
      },
      getCellDayEl: function (t) {
      ...
      computeDateTop: function (t, i) {
        return this.computeTimeTop(
          e.duration(t.clone().stripZone() - i.clone().stripTime())
        );
      },
      computeTimeTop: function (t) {
        var e,
          ...
          n,
          r,
          o = (t - this.minTime) / this.slotDuration;
        return (
          (o = Math.max(0, o)),
          ...
          (i = o - e),
          (n = this.slatTops[e]),
          i ? ((r = this.slatTops[e + 1]), n + (r - n) * i) : n
        );
      },
      ...
      renderDrag: function (t, e, i) {
        ...
        return i
          ...
          : (this.renderHighlight(
              t,
              e || this.view.calendar.getDefaultEventEnd(!1, t)
            ),
            void 0);
      },
      destroyDrag: function () {
      ...
      renderHelper: function (e, i) {
        ...
        this.helperEl = t('<div class="fc-helper-skeleton"/>')
          .append(l)
          .appendTo(this.el);
      },
      destroyHelper: function () {
      ...
      renderHighlight: function (e, i) {
        this.highlightEl = t(this.highlightSkeletonHtml(e, i)).appendTo(
          this.el
        );
      },
      destroyHighlight: function () {
        this.highlightEl &&
          (this.highlightEl.remove(), (this.highlightEl = null));
      },
      highlightSkeletonHtml: function (t, e) {
        var i,
          n,
        ...
        for (i = 0; a.length > i; i++)
          (n = a[i]),
            n.col > d &&
              ((c += '<td colspan="' + (n.col - d) + '"/>'), (d = n.col)),
            (r = l.cellToDate(0, d)),
            (o = this.computeDateTop(n.start, r)),
            (s = this.computeDateTop(n.end, r)),
            (c +=
              '<td><div class="fc-highlight-container"><div class="fc-highlight" style="top:' +
              o +
              "px;bottom:-" +
              s +
              'px"/>' +
            ...
            d++;
        return (
          l.colCnt > d && (c += '<td colspan="' + (l.colCnt - d) + '"/>'),
    ...
    t.extend(re.prototype, {
      ...
      renderEvents: function (e) {
        ...
        (this.eventSkeletonEl = t('<div class="fc-content-skeleton"/>').append(
          i.tableEl
        )),
      ...
      renderEventTable: function (e) {
        ...
        for (
          ...
          for (
            s = i[o], oe(s), l = t('<div class="fc-event-container"/>'), n = 0;
            s.length > n;
            n++
          )
            (r = s[n]),
      ...
      updateSegVerticals: function () {
        var t,
          e = this.segs;
        if (e)
          for (this.computeSegVerticals(e), t = 0; e.length > t; t++)
      ...
      renderSegHtml: function (t, e) {
        ...
        return (
          c.unshift("fc-time-grid-event"),
          o.isMultiDayEvent(s)
            ? (t.isStart || t.isEnd) &&
              ((i = o.getEventTimeText(t.start, t.end)),
              (n = o.getEventTimeText(t.start, t.end, "LT")),
              (r = o.getEventTimeText(t.start, null)))
            : ((i = o.getEventTimeText(s)),
          ...
          '<a class="' +
            ...
            (i
              ? '<div class="fc-time" data-start="' +
                ...
                "</div>"
              : "") +
            (s.title ? '<div class="fc-title">' + R(s.title) + "</div>" : "") +
            "</div>" +
            '<div class="fc-bg"/>' +
            (a ? '<div class="fc-resizer"/>' : "") +
            "</a>"
        );
      },
      generateSegPositionCss: function (t) {
        ...
        return (
          o && (l = Math.min(1, s + 2 * (l - s))),
          r ? ((e = 1 - l), (i = s)) : ((e = s), (i = 1 - l)),
          (a.zIndex = t.level + 1),
          (a.left = 100 * e + "%"),
          (a.right = 100 * i + "%"),
    ...
    t.extend(ge.prototype, {
      ...
      numberIntroHtml: function (t) {
        return this.weekNumbersVisible
          ? '<td class="fc-week-number" ' +
              ...
              ">" +
              "<span>" +
              this.calendar.calculateWeekNumber(this.cellToDate(t, 0)) +
              "</span>" +
              "</td>"
          : void 0;
      },
      ...
      numberCellHtml: function (t, e, i) {
        ...
        return this.dayNumbersVisible
          ? ((n = this.dayGrid.getDayClasses(i)),
      ...
      updateWidth: function () {
        this.weekNumbersVisible &&
          (this.weekNumberWidth = p(this.el.find(".fc-week-number")));
      },
      setHeight: function (t, e) {
        ...
        v(this.scrollerEl),
          ...
          !e &&
            m(this.scrollerEl, i) &&
            (h(this.headRowEl, w(this.scrollerEl)),
            (i = this.computeScrollerHeight(t)),
    ...
    t.extend(pe.prototype, {
      ...
      render: function (t) {
        ...
        (this.intervalStart = t.clone().stripTime().startOf("month")),
          ...
          this.isFixedWeeks() && (this.end.add(6 - e, "weeks"), (e = 6)),
  ...
  (Ee.prototype = H(fe.prototype)),
    t.extend(Ee.prototype, {
      ...
      setHeight: function (t, e) {
        ...
        null === this.bottomRuleHeight &&
          ...
          e ||
            ...
            m(this.scrollerEl, n)
              ? (h(this.noScrollRowEls, w(this.scrollerEl)),
                (n = this.computeScrollerHeight(t)),
                this.scrollerEl.height(n),
                this.restoreScroll())
              : (this.scrollerEl.height(n).css("overflow", "hidden"),
      ...
      renderDrag: function (t, e, i) {
        return t.hasTime()
          ? this.timeGrid.renderDrag(t, e, i)
          : this.dayGrid
          ? this.dayGrid.renderDrag(t, e, i)
          : void 0;
      },
      destroyDrag: function () {
      ...
      renderSelection: function (t, e) {
        t.hasTime() || e.hasTime()
          ? this.timeGrid.renderSelection(t, e)
          : this.dayGrid && this.dayGrid.renderSelection(t, e);
      },
      destroySelection: function () {
